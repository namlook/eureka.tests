    ...
    it('should list items', function(done) {
        ...
        Ember.RSVP.all(models).then(function() {
            ...
            andThen(function() {
                ...
                equal(find('.eureka-item-description:eq(0)').text().trim(), "4: basic title 0", 'the title matches');
            ...
            andThen(function() {
                equal(find('.eureka-document-title').text().trim(), "basic title 1 and literal 0", 'the title is correct');
    ...
    it('should query items', function(done) {
        ...
        Ember.RSVP.all(models).then(function() {
            ...
            andThen(function() {
                ...
                equal(find('.eureka-item-title:eq(0)').text().trim(), "basic title 1 and literal 0", 'the title is correct');
