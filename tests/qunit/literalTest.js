...
test('disaply a new literal form', function() {
    visit("/");
...
test('Edit a Basic relation from a Literal', function() {
    ...
    andThen(function() {
        notEqual(currentURL().match(/^\/Basic\/\w+\/edit/), null, 'We are editing a basic page');
    });
});

test('Create a literal with relation', function() {
    App.db.Basic.get('model').create({content: {
        title: 'basic title',
        description: 'basic description',
        thumb: 'http://placehold.it/65x65'
